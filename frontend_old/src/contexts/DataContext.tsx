...
// FIX: Changed type import from '@pediaquiz/types' to the correct package '@pediaquiz/types'
import type { AppData, DataContextType, DebugData, QuizResult, AttemptedMCQs, Theme, AppUser, DebugLog } from '@pediaquiz/types';
