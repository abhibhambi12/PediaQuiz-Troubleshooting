...
import type { UserUpload, AwaitingReviewData, Topic, MCQ, Flashcard } from "@pediaquiz/types";
    ...
    const renderCurrentStep = () => {
        switch (status) {
            ...
            case 'pending-review':
                ...
                // FIX: Explicitly type 'c' as Chapter for some method
                const currentTopic = topics.find(t => t.name === finalTopic);
                const isNewChapter = !currentTopic?.chapters.some((c: { name: string; }) => c.name === finalChapter);
